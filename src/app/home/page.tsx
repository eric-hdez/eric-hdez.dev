...
import { ColorPaletteProp, Grid, IconButton, Stack, Typography } from '@mui/joy';
import GitHubIcon from '@mui/icons-material/GitHub';
import LinkedInIcon from '@mui/icons-material/LinkedIn';
import InstagramIcon from '@mui/icons-material/Instagram';
import XIcon from '@mui/icons-material/X';

import eric from '../../../public/pfp.jpg';
        ...
        <Stack direction="column" justifyContent="space-between" spacing={8}>
          ...
          <Stack direction="row" spacing={2}>
            {buttons.map(({ link, description, icon, color }) => (
              <Link key={description} href={link} rel="noopener noreferrer" target="_blank">
                <IconButton
                  title={description}
